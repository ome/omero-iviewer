...
import {prepareResolutions} from '../../src/viewers/viewer/utils/Misc';
...
describe("Misc", function() {
    it('prepareResolutions', function() {
        var resolutions = prepareResolutions([]);
        expect(resolutions.length).to.eql(80);
        expect(resolutions[40]).to.eql(1);
        resolutions = prepareResolutions([1]);
        expect(resolutions.length).to.eql(80);
        expect(resolutions[40]).to.eql(1);
        resolutions = prepareResolutions([2.2,0.6, 0.1]);
