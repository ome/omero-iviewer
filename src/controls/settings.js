...
export default class Settings extends EventSubscriber {
    ...
    /**
    * Change channel range & color
    *
    * @memberof Settings
    */
   changeChannelRange() {
       /** TODO: put ui elements there...
        this.context.publish(
            IMAGE_CHANNEL_RANGE_CHANGE,
            { config_id: this.config_id, ranges:
                [{index: 0, start: 0, end: 100, color: "FFFF00"},
                {index: 1, start: 100, end: 150, color: "070BA2"},
                {index: 2, start: 100, end: 200, color: "FF0000"}]});
        */
    }
